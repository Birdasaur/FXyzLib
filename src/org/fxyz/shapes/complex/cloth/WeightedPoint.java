...
public class WeightedPoint {
    ...
    public WeightedPoint(ClothMesh parent, float mass) {
        this(parent, mass, 0, 0, 0, false);
    }
    ...
    public WeightedPoint(ClothMesh parent, float mass, float x, float y, float z) {
        this(parent, mass, x, y, z, false);
    }
    ...
    public void attatchTo(WeightedPoint other, double linkDistance, double stiffness) {
